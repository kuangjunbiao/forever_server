...
public class APIServerApplication {
    ...
    // public static UserCenterApiConfig config;
    //
    // @Autowired
    // public static void setConfig(UserCenterApiConfig config) {
    // APIServerApplication.config = config;
    // }
	...
	logger.info("系统启动...");
	// logger.info(config.getApiboundMobile());
