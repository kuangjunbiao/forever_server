...
public class UserInfoController {
    ...
    @ResponseBody
    public Object getUserList(HttpServletRequest request, @RequestParam(required = false, defaultValue = "1") int page,
	    @RequestParam(required = false, defaultValue = "10") int pageSize) throws Exception {
	PageInfo<TbUserEntity> pageInfo = tbUserService.getUserPageInfo(page, pageSize);
	...
	Map<String, Object> list = tbUserService.queryUserDetail(Long.parseLong(userId));
